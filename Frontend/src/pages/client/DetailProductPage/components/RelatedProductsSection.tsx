...
export default function RelatedProductsSection({category_id, product_id}: {category_id?: number, product_id?: number}) {
    ...
    return (
        <div className="rounded-xl overflow-hidden mb-[100px]">
            {/* Header Section */}
            <div className="relative  px-8 py-6 bg-gray-400">
            ...
            {/* Products Section */}
            <div className="px-8 py-8 bg-gradient-to-b from-gray-200/50 to-white">
