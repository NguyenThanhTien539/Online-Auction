...
export async function getAllCategoriesLv2(req : Request, res : Response) {
    ...
    const resultData = await categoriesModel.getAllCategoriesLv2(Number(id), String(slug));
    if (resultData === null) {
...
export async function getAll(_ : Request, res: Response) {
    ...
    console.log("Formatted Categories Data: ", JSON.stringify(formattedData, null, 2));
